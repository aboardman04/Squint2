...
from .two_camera_base_random_env import TwoCameraEnv, DefaultRandomizationConfig
...
class TwoCameraLift(TwoCameraEnv):
    """
    **Task Description:**
...
@register_env("2Camera-SO101LiftCube-v1", max_episode_steps=50)
class LiftCubeTwoCamera(TwoCameraLift):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, item_type="cube", **kwargs)

@register_env("2Camera-SO101LiftCan-v1", max_episode_steps=50)
class LiftCanTwoCamera(TwoCameraLift):
    def __init__(self, *args, **kwargs):
